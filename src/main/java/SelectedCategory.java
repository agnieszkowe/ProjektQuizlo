...
public class SelectedCategory extends JFrame{
    ...
    public SelectedCategory() throws IOException {
        ...
        deleteQuiz1.addActionListener(new ActionListener() { //BLOCK THE BUTTON IF ONCE CLICKED ON
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String quizname_ = quizname.replace(" ","-");
                try {
                    AllQuizesData.deleteQuiz(quizname_,categoryName);
    ...
    public static ArrayList<String> xd(String categoryName) throws FileNotFoundException { //read things
        AllQuizesData.readNames();
        AllQuizesData.minusesToSpace2();
        ArrayList<Integer> indexList = new ArrayList<>();
        ArrayList<String> quizNames = new ArrayList<>();
        for (int i = 0; i < AllQuizesData.allQuizNamesData.size(); i++) {
            if (categoryName.equals(AllQuizesData.allQuizNamesData.get(i))) {
                indexList.add(i);
                quizNames.add(AllQuizesData.allQuizNamesData.get(i-1));
            }
        }
        return quizNames;
    }
    ...
    public void refresh() throws FileNotFoundException {
        ArrayList<String> quizNames = new ArrayList<>();
        AllQuizesData.allQuizNamesData.clear();
        AllQuizesData.allQuizData.clear();
        AllQuizesData.read();
        AllQuizesData.minusesToSpace2();
        String categoryName = Categories.categoryName;

        categoryLabel.setText(categoryName);
        quizNames = xd(categoryName);
